...
#window (GUI) class. It runs as a thread, to function indepently of the stdout stream generated by yowsup client/stacks.    
class window(Thread):
    class group():
    ...
    def run(self):#this function is started on __init___, because the window is a Thread. Initialize GUI and its widgets.
        self.root = Tk()
